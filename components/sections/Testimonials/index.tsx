...
function Testimonial() {
  return (
    <div className="flex flex-col lg:p-20 p-5 lg:mt-0 mt-10 text-white bg-gray-800 gap-5 z-40">
      <div className="lg:text-5xl text-4xl text-center font-bold text-[#FFD700] ">
        What people{" "}
        <span className="text-[#FF9900] lg:text-5xl text-4xl text-center font-bold">
          say
        </span>{" "}
        about us
      </div>
      <div className="flex flex-col lg:flex-row justify-between items-center">
        ...
        <div className="flex flex-col  p-10 w-auto">
          <div className="w-full rounded-xl bg-black p-6 shadow-yellow-700 shadow-sm  shadow-lg sm:w-96  overflow-hidden ">
            ...
            <div className="mb-6 text-justify sm:mb-4">
              ...
              skilled, communicated clearly, and the final product was
              top-notch. Definitely worth working with.
            </div>
