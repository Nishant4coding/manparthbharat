  ...
  const Links = ({ direction }: LinkProp) => {
    return (
      <div className={`flex ${direction} justify-between gap-y-6 mt-16  ${direction==="row" ? "gap-x-6" : ""}`}>
        <a href="https://twitter.com/ecellgu?s=20&t=vFxkKJJOyuDxqgjbNkXRrQ" target="_blank" rel="noreferrer">
          {/* <img src={twitter} alt="twitter" className='w-5' /> */}
          <Twitter strokeWidth={2}
                className="group-hover:scale-125 hover:text-yellow-300 text-white transition-transform duration-250 ease-in-out"
              />
        </a>
        <a href="https://www.instagram.com/ecellgu/" target="_blank" rel="noreferrer">
          ...
          <Instagram strokeWidth={2}
                className="group-hover:scale-125 text-white hover:text-yellow-300 transition-transform duration-250 ease-in-out"
              />
        </a>
        ...
        <a href="https://www.linkedin.com/company/entrepreneurship-cell-galgotias-university/" target="_blank" rel="noreferrer">
...
{/* <BubbleUnderlay
   ...
   <div className=" ">
    ...
    <div className="hidden sm:flex flex-row max-w-full mr-auto z-30">
  <div className="ontop fixed flex px-2 h- items-center justify-center right-0">
    <div className="flex flex-col justify-center gap-y-6 items-center ">
      ...
      <div className="mt-20 uppercase text-sm font-semibold origin-center rotate-[90deg] tracking-wide">
        <h1 className="text-white ">ManParth</h1>
      </div>
    </div>
  </div>
</div>
